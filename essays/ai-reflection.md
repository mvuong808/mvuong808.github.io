...
* **Experience WODs e.g. E18**
  * I didn't use AI for the Experience WODs, as there was often a demonstration video explaining the solution, and I felt like I needed to know the fundamental information taught in the experience.
* **In-class Practice WODs**
  * I used AI for the In-class Practice WODs, as I knew I had more of a time constraint and wanted to see how quickly I could complete the WOD so I was prepared for the actual WOD. For example, I would ask ChatGPT to "read the instructions of the WOD provided and generate a list of requirements" before starting the actual WOD. From there, I would usually go step by step in the WOD instructions, having ChatGPT generate each step, and then checking if the code it provided was accurate or not.
* **In-class WODs**
  * I used AI in the same way for the In-class WODs as the In-class practice WODs, however during the practice WODs, I usually tinkered around more with the prompts and code, but for the In-class WODs, I didn't want to waste any time, so I would just stick to what worked in the practice WODs.
* **Essays**
  * I did not use AI for the essays, as I felt that AI wouldn't fully know what my past experiences or thoughts about a certain topic would be, and that it would be more work to provide it with that information than if I were to just do it myself. In addition, I feel that AI essays can often be too detailed and monotonous to read, so by writing it myself I could make it more concise and add some humor. 
* **Final project**
  * I used AI for my final project, similar to how I did in the practice WODs, but I did find that I was using AI for a lot more of the non-coding process than before. For example, when changing the style of the application, I asked ChatGPT to "list various patterns and color themes that fit my website's purpose", to see what might look good. A lot of the times I was unsure of what was best, but asking ChatGPT to give me examples to look at definitely helped me make a decision. 
* **Learning a concept / tutorial**
  * I sometimes used AI to learn a concept/tutorial, as some concepts can be quite complex. For example, I didn't know what Prisma migrations were and what they did. I often got errors on my final project due to these migrations, but ChatGPT was able to explain them to me when I asked it "What are Prisma migrations, and why do I often get errors when creating migrations?" Using AI, I was able to resolve a lot of problems and learn more about what caused them in the first place.
* **Answering a question in class or in Discord**
  * I didn't use AI answering questions, as I figured that if I knew the answer to a questions I would answer it, but if I didn't it wasn't worth going to AI just to ask it for an answer, as the other person who is asking the question could just do that themself.
* **Asking or answering a smart-question**
  * Same thing as answering a question, I didn't use AI, I felt like if someone really had a question, they probably would have already asked AI for help if they couldn't figure it out, so unless I already knew the answer, it would be redundant to ask AI again.
* **Coding example e.g. “give an example of using Underscore .pluck”**
  * I used AI a few times to give me coding examples, as I found it was very helpful in learning a concept. Most times, even if I just asked "what is ___" concept, it would end up giving my an example even though I didn't ask. 
* **Explaining code**
  * AI was also very useful when explaining code, as there was often times where I didn't understand how the code it generated worked, but it was able to break it down and explain how it worked pretty well. 
* **Writing code**
